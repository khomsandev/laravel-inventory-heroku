...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        //return Product::with('ชื่อ function','ชื่อตาราง')->orderBy('id','desc')->paginate(25);
    ...
    public function store(Request $request)
    {
        ...
        if ($user->tokenCan("1"))
        {
            ...
            //กำหนดตัวแปรรับค่าจากฟอร์มที่ VueJS
            $data_product = array(
            ...
            // รับไฟล์รูปภาพเข้ามาจาก VueJS
            $image = $request->file('file');

            // เช็คว่ามีการ Upload รูปภาพมาหรือเปล่า
            if(!empty($image)){
